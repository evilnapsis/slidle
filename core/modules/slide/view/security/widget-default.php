	...
	<br>
		<div class="panel panel-default">
        	...
        	<div class="list-group">
					<a href='index.php?view=configuration' class='list-group-item'><i class="glyphicon glyphicon-chevron-right"></i> Informacion</a>
					<a href='index.php?view=image' class='list-group-item'><i class="glyphicon glyphicon-chevron-right"></i> Imagen</a>
